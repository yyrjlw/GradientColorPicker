...
export const colorTypeBtnStyles = (selected: boolean, styles: Styles) => {
  if (selected) {
...
export const controlBtnStyles = (selected: boolean, styles: Styles) => {
  if (selected) {
...
export const modalBtnStyles = (selected: boolean, styles: Styles) => {
  if (selected) {
