...
const TrashIcon = defineComponent({
  ...
  setup() {
    ...
    return () => (
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" style={{ width: 15 + 'px' }}>
        <polyline
          stroke-linecap="round"
          stroke-linejoin="round"
          style={{ ...styles, ...defaultStyles.value.rbgcpControlIcon }}
...
export const LinearIcon = defineComponent({
  ...
  setup(props) {
    ...
    return () => (
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" style={{ width: 14 + 'px' }}>
        <polyline
          stroke-linecap="round"
          stroke-linejoin="round"
          style={{
...
export const RadialIcon = defineComponent({
  name: 'RadialIcon',
  props: {
    color: {
      type: String,
...
export const SlidersIcon = defineComponent({
  name: 'SlidersIcon',
  props: {
    color: {
      type: String,
  ...
  setup(props) {
    ...
    return () => (
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" style={{ width: 17 + 'px' }}>
        <polyline
          fill-rule="evenodd"
          stroke-linecap="round"
          stroke-linejoin="round"
...
export const InputsIcon = defineComponent({
  name: 'InputsIcon',
  props: {
    color: {
      type: String,
      ...
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" style={{ width: 17 + 'px' }}>
        ...
        <path
          style={{
            ...
            ...defaultStyles.value.rbgcpControlIcon,
            ...defaultStyles.value.rbgcpControlIcon2,
            ...(col.value && { fill: col.value, stroke: col.value })
          }}
...
export const DegreesIcon = defineComponent({
  name: 'DegreesIcon',
  props: {
    color: {
      type: String,
...
export const StopIcon = defineComponent({
  ...
  setup() {
    ...
    return () => (
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" style={{ width: 20 + 'px', marginRight: 1 + 'px' }}>
        <path
          style={{ ...defaultStyles.value.rbgcpControlIcon2 }}
        ...
        />
        <path style={{ ...defaultStyles.value.rbgcpControlIcon2 }} d="M4.79,8.09V7H9.16V8.09H7.59V13H6.38V8.09Z" />
        <path
          style={{ ...defaultStyles.value.rbgcpControlIcon2 }}
